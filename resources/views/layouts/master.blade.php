...
<html lang="en">
  <head>
    ...
    @section('styles')
        ...
        <link href="{{ url('css/bootstrap.min.css') }}" rel="stylesheet"> <!-- Bootstrap core CSS -->
        
        <link href="{{ url('css/ie10-viewport-bug-workaround.css') }}" rel="stylesheet"> <!-- IE10 viewport hack for Surface/desktop Windows 8 bug --> 

        <link href="{{ url('css/starter-template.css') }}" rel="stylesheet"> - <!-- Custom styles for this template -->
